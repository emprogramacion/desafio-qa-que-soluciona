...
def test_1():
    ...
    print(f"Test 1 - Expected: {expected_output}, Got: {output}")
...
def test_2():
    ...
    output = shortestReach(n, edges, s)
    print(f"Test 2 - Expected: {expected_output}, Got: {output}")
    assert output == expected_output
...
def test_3():
    ...
    output = shortestReach(n, edges, s)
    print(f"Test 3 - Expected: {expected_output}, Got: {output}")
    assert output == expected_output
...
def test_4():
    ...
    output = shortestReach(n, edges, s)
    print(f"Test 4 - Expected: {expected_output}, Got: {output}")
    assert output == expected_output
...
def test_5():
    ...
    output = shortestReach(n, edges, s)
    print(f"Test 5 - Expected: {expected_output}, Got: {output}")
    assert output == expected_output
